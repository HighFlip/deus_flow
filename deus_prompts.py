...
{{"user_goal": "retrieved_goal"}}

Ensure that the user goal is accurately extracted and formatted as shown in the example. Do not include any additional text in your response."""
